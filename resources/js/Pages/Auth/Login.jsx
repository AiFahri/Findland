            ...
            <div className="w-full max-w-[1300px] flex gap-2 p-8">
                ...
                <div className="flex-1 hidden lg:block">
                    <div className="relative h-full w-full rounded-3xl overflow-hidden">
                        <img src={house} alt="Modern House" className="w-full h-full object-cover" />
                    </div>
                </div>
                ...
                <div className="flex-1 max-w-[500px] pl-12">
                    <div className="mb-8">
                        <h2 className="flex items-center justify-center text-4xl font-medium font-sonsie text-pandanwangi mb-8 mt-10">Findland</h2>
                        <h3 className="text-3xl font-extrabold mb-1">Sign In</h3>
                        <p className="text-gray-600">
                            Belum punya akun?{' '}
                            <p> Anda bisa <Link href={route('register')} className="text-red-500 hover:underline font-extrabold">
                                Daftar disini!
                            </Link></p>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="relative flex items-center">
                            <img src={emailIcon} alt="Email" className="w-5 h-5 absolute left-0" />
                            <input
                                type="email"
                        ...
                        <div>
                            <div className="relative flex items-center">
                                <img src={lockIcon} alt="Lock" className="w-5 h-5 absolute left-0" />
                                <input
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link href={route('password.request')} className="text-sm text-pandanwangi hover:underline">
                                Lupa password?
                            </Link>
                        </div>
                        ...
                        <div className="text-center text-gray-500">
                            ...
                            <div className="flex justify-center gap-4 mt-4">
                                <button type="button" className="p-2 border rounded-full hover:bg-gray-50 transition">
