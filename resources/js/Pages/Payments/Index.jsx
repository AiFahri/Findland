                        ...
                        <div className="p-6 text-gray-900">
                            ...
                            {payments.length === 0 ? (
                                <div className="text-center py-8">
                                    <p className="text-gray-500">Anda belum memiliki riwayat pembayaran.</p>
                                </div>
                            ) : (
                                                ...
                                                <tr key={payment.id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            ...
                                                            <span className={`ml-2 px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusTextClass(payment.status)}`}>
                                                                {payment.status === 'paid' ? 'Dibayar' :
                                                                 ...
                                                                 payment.status === 'denied' ? 'Ditolak' : payment.status}
                                                            </span>
                                                        </div>
                                                    </td>
