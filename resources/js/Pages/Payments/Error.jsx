...
export default function Error({ payment, package: pkg, landListing }) {
    return (
        <MainLayout>
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            ...
                            <div className="bg-red-50 border border-red-200 p-4 rounded-lg mb-6">
                                <h2 className="text-lg font-medium text-red-800 mb-2">Kemungkinan Penyebab</h2>
                                <ul className="list-disc list-inside text-red-700 space-y-2">
                                    <li>Saldo tidak mencukupi</li>
                                    <li>Kartu kredit/debit ditolak</li>
                                    <li>Masalah pada gateway pembayaran</li>
