...
const Beli = () => {
    const locations = [
        ...
        ...new Set(
            datatanah
                .filter((item) => item.status === "Dijual")
            ...
            <div className="mb-6">
                <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
                    ...
                    <select
                        ...
                        className="md:hidden w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-bunulrejo"
                    >
